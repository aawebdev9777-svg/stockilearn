...
export const LESSONS = [
  ...
  { id: "1.3", unit: 1, title: "Bulls, Bears, and What They Mean", xp: 15, time: 5, teaser: "Meet Bruno the Bull and Bella the Bear — they'll explain market trends.",
    slides: [
      ...
      { text: "When prices DROP significantly, it's a Bear Market 🐻. Bears swipe downward!", visual: "bear", detail: "A bear market = a 20%+ decline from recent highs. They're scary in the moment, but they're a normal part of investing cycles.", example: "During the 2008 financial crisis, the S&P 500 dropped 57%. Terrifying — but it fully recovered in 4 years." },
      { text: "A correction is when prices drop 10% from a peak. A crash is 20%+. Scary but normal!", visual: "correction", detail: "Corrections happen roughly once a year on average. They feel alarming but are actually healthy — they reset overinflated prices.", example: "In 2022, the NASDAQ dropped over 30% — a full bear market. By 2023, it had mostly recovered." },
      { text: "Since 1928, the market has ALWAYS recovered from bear markets. Patience wins!", visual: "recovery", detail: "The average bear market lasts about 9 months. The average bull market lasts about 3 years. Time in the market beats timing the market.", example: "Anyone who held through the 2020 COVID crash (−35%) and didn't panic-sell was up 100%+ within 18 months." },
    ],
    questions: [
