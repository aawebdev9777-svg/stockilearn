  ...
  return (
    <div className="px-4 pt-6 pb-4 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link to="/settings" className="w-10 h-10 rounded-2xl border border-white/50 flex items-center justify-center text-gray-500 hover:text-gray-800 transition-colors" style={{ background: "rgba(255,255,255,0.55)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)" }}>
      ...
      <div>
        ...
        <Card className="p-4 rounded-2xl border border-white/50 space-y-3" style={{ background: "rgba(255,255,255,0.55)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)" }}>
...
function StatCard({ label, value, icon }) {
  return (
    <Card className="p-3 rounded-2xl border border-white/50 text-center" style={{ background: "rgba(255,255,255,0.55)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)" }}>
